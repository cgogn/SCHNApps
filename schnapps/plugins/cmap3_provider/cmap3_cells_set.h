...
#ifndef SCHNAPPS_PLUGIN_CMAP3_PROVIDER_CMAP3_CELLS_SET_H_
#define SCHNAPPS_PLUGIN_CMAP3_PROVIDER_CMAP3_CELLS_SET_H_
...
class SCHNAPPS_PLUGIN_CMAP3_PROVIDER_API CMap3CellsSetGen : public QObject
{
	Q_OBJECT
...
public:
	...
	CMap3CellsSetGen(const CMap3Handler& mh, const QString& name);
	~CMap3CellsSetGen();

	inline const QString& name() { return name_; }

	virtual const CMap3Handler& map_handler() const { return mh_; }
...
class CMap3CellsSet : public CMap3CellsSetGen
{
public:

	using Inherit = CMap3CellsSetGen;
	using Self = CMap3CellsSet<CELL>;

	CMap3CellsSet(CMap3Handler& mh, const QString& name) :
		Inherit(mh, name),
		marker_(*mh.map())
	{}

	~CMap3CellsSet() override
	{}
...
protected:
	...
	typename CMap3::template CellMarker<CELL::ORBIT> marker_;
...
#endif // SCHNAPPS_PLUGIN_CMAP3_PROVIDER_CMAP3_CELLS_SET_H_
