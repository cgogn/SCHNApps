...
#ifndef SCHNAPPS_PLUGIN_CMAP0_PROVIDER_DOCK_TAB_H_
#define SCHNAPPS_PLUGIN_CMAP0_PROVIDER_DOCK_TAB_H_

#include <schnapps/plugins/cmap0_provider/dll.h>

#include <schnapps/core/types.h>

#include <ui_cmap0_provider.h>
...
class SCHNAPPS_PLUGIN_CMAP0_PROVIDER_API CMap0Provider_DockTab : public QWidget, public Ui::CMap0Provider_TabWidget
{
	Q_OBJECT

public:

	CMap0Provider_DockTab(SCHNApps* s, Plugin_CMap0Provider* p);
	~CMap0Provider_DockTab() override;

private:

	SCHNApps* schnapps_;
	Plugin_CMap0Provider* plugin_;
...
public:
	...
	void add_map(CMap0Handler* mh);
	void remove_map(CMap0Handler* mh);
...
#endif // SCHNAPPS_PLUGIN_CMAP0_PROVIDER_DOCK_TAB_H_
