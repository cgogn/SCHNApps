...
#ifndef SCHNAPPS_PLUGIN_CMAP0_PROVIDER_CMAP0_CELLS_SET_H_
#define SCHNAPPS_PLUGIN_CMAP0_PROVIDER_CMAP0_CELLS_SET_H_
...
class SCHNAPPS_PLUGIN_CMAP0_PROVIDER_API CMap0CellsSetGen : public QObject
{
	Q_OBJECT
...
public:
	...
	CMap0CellsSetGen(const CMap0Handler& mh, const QString& name);
	~CMap0CellsSetGen();

	inline const QString& name() { return name_; }

	virtual const CMap0Handler& map_handler() const { return mh_; }
...
class CMap0CellsSet : public CMap0CellsSetGen
{
public:

	using Inherit = CMap0CellsSetGen;
	using Self = CMap0CellsSet<CELL>;

	CMap0CellsSet(CMap0Handler& mh, const QString& name) :
		Inherit(mh, name),
		marker_(*mh.map())
	{}

	~CMap0CellsSet() override
	{}
...
protected:
	...
	typename CMap0::template CellMarker<CELL::ORBIT> marker_;
...
#endif // SCHNAPPS_PLUGIN_CMAP0_PROVIDER_CMAP0_CELLS_SET_H_
