...
class PLUGIN_CMAP_PROVIDER_EXPORT UndirectedGraphHandler : public CMapHandlerGen
{
	Q_OBJECT
...
public:
	...
	UndirectedGraphHandler(const QString& name, PluginProvider*);
	~UndirectedGraphHandler() override;
