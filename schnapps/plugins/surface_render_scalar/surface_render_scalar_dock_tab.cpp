...
void SurfaceRenderScalar_DockTab::object_added(Object* o)
{
	CMap2Handler* mh = dynamic_cast<CMap2Handler*>(o);
	if (mh)
		map_added(mh);
...
void SurfaceRenderScalar_DockTab::map_added(CMap2Handler *mh)
{
	updating_ui_ = true;
...
void SurfaceRenderScalar_DockTab::object_removed(Object* o)
{
	CMap2Handler* mh = dynamic_cast<CMap2Handler*>(o);
	if (mh)
		map_removed(mh);
...
void SurfaceRenderScalar_DockTab::map_removed(CMap2Handler *mh)
{
	if (selected_map_ == mh)
	{
		disconnect(selected_map_, SIGNAL(vbo_added(cgogn::rendering::VBO*)), this, SLOT(selected_map_vbo_added(cgogn::rendering::VBO*)));
...
void SurfaceRenderScalar_DockTab::selected_view_changed(View*, View*)
{
	if (plugin_->check_docktab_activation())
		refresh_ui();
}
